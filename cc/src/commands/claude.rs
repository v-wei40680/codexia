...
fn find_claude_binary(_app_handle: &AppHandle) -> Result<String, String> {
    claude_discovery::discover_claude_command()
        .ok_or_else(|| "Unable to locate claude_path.".to_string())
