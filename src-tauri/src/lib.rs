    ...
    let builder = {
        ...
        builder
            ...
            .invoke_handler(tauri::generate_handler![
                ...
                crate::commands::fs::read_directory,
                crate::commands::fs::get_home_directory,
                crate::commands::fs::search_files,
                crate::commands::fs::search_files_by_name,
                crate::commands::fs::canonicalize_path,
                crate::commands::fs::read_file,
                crate::commands::fs::read_text_file_lines,
                crate::commands::fs::write_file,
                crate::commands::fs::delete_file,
                crate::commands::fs::read_pdf_content,
                crate::commands::fs::read_xlsx_content,
                crate::commands::fs::start_watch_directory,
                crate::commands::fs::stop_watch_directory,
                crate::commands::fs::start_watch_file,
                crate::commands::fs::stop_watch_file,
