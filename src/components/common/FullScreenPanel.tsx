...
export const FullScreenPanel: React.FC<FullScreenPanelProps> = ({
  ...
  return createPortal(
    ...
    >
      {/* Header */}
      <div className="flex-shrink-0 py-3 border-b border-border-default bg-background">
      ...
      {/* Footer */}
      {footer && (
        <div className="flex-shrink-0 py-4 border-t border-border-default bg-background">
