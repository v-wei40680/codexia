...
import type { QueuedMessage, ThreadTokenUsage } from "@/types/codex-v2";
import { useComposerAutocompleteStateV2 } from "@/hooks/codex/v2/useComposerAutocompleteStateV2";
...
export function Composer({
  ...
  } = useComposerAutocompleteStateV2({
    text,
    selectionStart,
    disabled,
    skills,
  ...
  return (
    <footer className={`flex flex-col gap-2 px-8 pt-3 pb-6 border-t border-white/[0.04] bg-[#0a0e14]/45 backdrop-blur-[18px] backdrop-saturate-[1.2] shrink-0 ${disabled ? "opacity-70 pointer-events-none" : ""}`}>
