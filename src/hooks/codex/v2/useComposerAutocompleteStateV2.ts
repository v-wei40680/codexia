...
import type { AutocompleteItem } from "./useComposerAutocompleteV2";
import { useComposerAutocompleteV2 } from "./useComposerAutocompleteV2";
...
export function useComposerAutocompleteStateV2({
  text,
  selectionStart,
  disabled,
  skills,
